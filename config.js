window.GOOD_KARMA_CONFIG = {
  ...
  statsGid: "1803586008",
  refreshSeconds: 2,
  celebrationSeconds: 15,
  hitColumns: {
    name: "Card Name", number: "Card Number", image: "Image URL",
    status: "Status", value: "Value", tier: "Tier",
    show: "Show on Board", celebrate: "Celebrate", winner: "Winner"
  },
